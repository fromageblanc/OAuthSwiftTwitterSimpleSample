...
- (id <OAuthSwiftRequestHandle> _Nullable)objc_authorizeWithCallbackURL:(NSString * _Nonnull)urlString success:(void (^ _Nonnull)(OAuthSwiftCredential * _Nonnull, OAuthSwiftResponse * _Nullable, NSDictionary<NSString *, id> * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
@end
...
- (id <OAuthSwiftRequestHandle> _Nullable)objc_authorizeWithCallbackURL:(NSString * _Nonnull)urlString scope:(NSString * _Nonnull)scope state:(NSString * _Nonnull)state parameters:(NSDictionary<NSString *, id> * _Nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * _Nullable)headers success:(void (^ _Nonnull)(OAuthSwiftCredential * _Nonnull, OAuthSwiftResponse * _Nullable, NSDictionary<NSString *, id> * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
@end
...
- (id <OAuthSwiftRequestHandle> _Nullable)get:(NSString * _Nonnull)urlString parameters:(NSDictionary<NSString *, id> * _Nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * _Nullable)headers success:(void (^ _Nullable)(OAuthSwiftResponse * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
- (id <OAuthSwiftRequestHandle> _Nullable)post:(NSString * _Nonnull)urlString parameters:(NSDictionary<NSString *, id> * _Nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * _Nullable)headers body:(NSData * _Nullable)body success:(void (^ _Nullable)(OAuthSwiftResponse * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
- (id <OAuthSwiftRequestHandle> _Nullable)put:(NSString * _Nonnull)urlString parameters:(NSDictionary<NSString *, id> * _Nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * _Nullable)headers body:(NSData * _Nullable)body success:(void (^ _Nullable)(OAuthSwiftResponse * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
- (id <OAuthSwiftRequestHandle> _Nullable)delete:(NSString * _Nonnull)urlString parameters:(NSDictionary<NSString *, id> * _Nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * _Nullable)headers success:(void (^ _Nullable)(OAuthSwiftResponse * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
- (id <OAuthSwiftRequestHandle> _Nullable)patch:(NSString * _Nonnull)urlString parameters:(NSDictionary<NSString *, id> * _Nonnull)parameters headers:(NSDictionary<NSString *, NSString *> * _Nullable)headers success:(void (^ _Nullable)(OAuthSwiftResponse * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
@end
...
- (id _Nullable)jsonObjectWithOptions:(NSJSONReadingOptions)opt error:(NSError * _Nullable * _Nullable)error;
- (id _Nullable)propertyListWithOptions:(NSPropertyListReadOptions)opt format:(NSPropertyListFormat * _Nullable)format error:(NSError * _Nullable * _Nullable)error;
@end
